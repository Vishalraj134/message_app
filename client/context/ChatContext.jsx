...
export const ChatProvider = ({children})=>{
    ...
    const sendMessage = async (messageData)=>{
        try{
            const {data}=await axios.post(`/api/message/send/${selectedUser.User._id}`,messageData);
            if(data.success){
                setMessages((prevMessages)=>[...preMessages,data.newMessage])
            }else{
    ...
    const value = {
        ...
        setSelectedUser,unseenMessage,setUnseenMessages
    }
